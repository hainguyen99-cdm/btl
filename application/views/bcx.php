	 		...
	 		<div id="contentDiv" class="container">
	 			<div id="padthDiv">
		            <ul class="path">
		                ...
		                <li><a href="#">Báo cáo xuất hàng hoá</a></li>
		            </ul>
		           
		        </div>
				<div id="import">
					<h3>Báo cáo xuất hàng hoá </h3>
					<table class="styled-table">
						...
						<tbody>
								<?php foreach ($listBcx as $key => $value):?>
								<tr>
									...
									{	
										...
										echo '<td><a href="deleteBcx/'.$value["mabaocao"].'">Xóa</a></td>';

									}
									?>
									<td><a href="view_detailBcx/<?php echo $value['mahoadonxuat'] ?>">Xem chi tiết</a></td>
								</tr>
								<?php endforeach; ?>
						</tbody>
					</table>
